...
public class GuiAdd extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        LiquidBounce.fontManager.PingFang20.drawCenteredString("Add Account", width / 2, 34, 0xffffff);
        LiquidBounce.fontManager.PingFang18.drawCenteredString( status == null ? "" : status, width / 2, height / 4 + 60, 0xffffff);
        ...
        if(password.getText().isEmpty() && !password.isFocused())LiquidBounce.fontManager.PingFang20.drawCenteredString("§7Password", width / 2 - 74, 91, 0xffffff);
