...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                j1 = (int) this.fontRendererInstance.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, (int) (i1 + 1 + this.fontRendererInstance.getHeight()), -3092272);
                }
                else
                {
            ...
            if (k != j)
            {
                int l1 = (int) (l + this.fontRendererInstance.getStringWidth(s.substring(0, k)));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, (int) (i1 + 1 + this.fontRendererInstance.getHeight()));
            }
        }
    }
